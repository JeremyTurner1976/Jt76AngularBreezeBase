    ...
    public class ErrorFactoryTests
    {
        ...
        public void GetErrorFromExceptionTest()
        {
            ...
            catch (DivideByZeroException e)
            {
                ...
                Assert.IsTrue(error.StrSource.Contains("Jt76Base.Data") && error.StrSource.Contains("ErrorFactory"));
        ...
        public void GetErrorAsHtmlTest()
        {
            ...
            catch (DivideByZeroException e)
            {
                ...
                Assert.IsTrue(error.Contains("Jt76Base.Data") && error.Contains("ErrorFactory"));
        ...
        public void GetAggregateErrorAsStringTest()
        {
            ...
            catch (AggregateException ae)
            {
                    ...
                    Assert.IsTrue(error.Contains("Jt76Base.Tests") && error.Contains("ErrorFactoryTests"));
            }
        }
